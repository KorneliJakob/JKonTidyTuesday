...
indoor_pollution <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/main/data/2022/2022-04-12/indoor_pollution.csv',show_col_types = FALSE)

no_legend <- theme(legend.position = "none")

set_theme(theme_ipsum_rc(base_family = "Roboto Condensed", base_size = 4))
...
ggplot(x ,aes(fill = death_risk_five_year))+
  ...
  labs(fill = "death risk change<br> in % since 1990")+
  theme(legend.position = "top")+
  coord_sf(datum = NA) + 
  theme(panel.background = element_rect(color = "black"),
        strip.text = element_text(size = 4, margin = margin(t = 1, b = 1)),
        legend.title =  element_markdown(size = 4))
  }
...
(asia + africa) +
  plot_annotation(
    ...
    theme = theme(
      ...
      plot.caption = element_markdown( size = 4, halign = 0),
...
ggsave(filename = "22-04-12_Indoor_Air_Pollution/pollution.jpg", width = 8, height = 6, units = "in", dpi = 120)
```
